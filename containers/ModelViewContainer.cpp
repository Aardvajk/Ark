...
ModelViewContainer::ModelViewContainer(Model *model, Graphics *graphics, Relay *relay, QWidget *parent) : GuiContainer(parent), model(model), graphics(graphics), relay(relay)
{
